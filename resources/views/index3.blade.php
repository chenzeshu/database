...
@section('content')
		...
		<div class="top_left">
			...
			<ul>
				...
				<li class="info-wrapper">
					<a href="{{url('approve/index')}}" class=" active">待审批申请（管理员）</a>
					@if($num)
	...
	<div class="menu_box">
		<ul>
			<li>
				...
				<ul class="sub_menu">
					<li class="info-wrapper"><a href="{{url('approve/approve')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>待审批</a>
						@if($num)
							<span class="info2">{{$num}}</span>
						@endif
					</li>
					<li><a href="{{url('approve/user')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>用户管理</a></li>
					<li><a href="{{url('approve/user')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>用户行为记录</a></li>
				</ul>
			</li>
        </ul>
	</div>
	...
	<!--主体部分 开始-->
	<div class="main_box">
		<iframe src="{{url('approve/approve')}}" frameborder="0" width="100%" height="100%" name="main"></iframe>
	</div>
	<!--主体部分 结束-->
