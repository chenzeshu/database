...
@section('content')
    ...
    <div class="result_wrap">
        <form action="{{url('admin/QT/'.$data->id)}}" method="post">
                ...
                <tr>
                    ...
                    <td>
                        <select name="fileid" id="">
                            <option value="1" @if($data['fileid']==1) selected @endif>本公司的产品第三方检测报告</option>
                            <option value="2" @if($data['fileid']==2) selected @endif>供方产品第三方产品检测报告</option>
                            <option value="3" @if($data['fileid']==3) selected @endif>按项目保存改装厂出厂验出资料</option>
                            <option value="4" @if($data['fileid']==4) selected @endif>系统集成项目出厂验收文件</option>
                            <option value="5" @if($data['fileid']==5) selected @endif>产品标准</option>
                            <option value="6" @if($data['fileid']==6) selected @endif>对外可开展合作业务证明</option>
                            <option value="7" @if($data['fileid']==7) selected @endif>培训证书</option>
                            <option value="8" @if($data['fileid']==8) selected @endif>仪器计量证书</option>
                        </select>
                    </td>
                </tr>
                <tr>
