...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/PR').'/'.session('fileid')}}">首页</a> &raquo; <a href="#">质量检测</a>
    </div>
    <!--面包屑导航 结束-->
        ...
        <div class="result_wrap">
            ...
            <div class="result_content">
                <div class="short_wrap">
                    ...
                    <input type="text" name="name" class="xs" placeholder="填写文档名称" id="search">
            ...
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{url('admin/QT/'.$v->id.'/edit')}}">修改</a>
    ...
    <script>
        ...
        function deleteObj(id){
            layer.confirm('确定删除这位仁兄？', {
                ...
                $.post("{{url('admin/QT/')}}/"+id,{'_method':'delete','_token':"{{csrf_token()}}"},function(data){
                    if(data.status=='0'){
        ...
        function add() {
            ...
            var filehome = '质量检测/'+"{{session('filetype')}}";
            $.post("{{url('sub/add')}}",{id:val,model:"quality",filehome:filehome,'_token':"{{csrf_token()}}"},function (data) {
                if (data.status == 0 ){
                    layer.msg(data.msg, {icon: 6});
                    setTimeout(function(){
                        location.href = location.href;
        ...
        function search() {
            ...
            $.post(url,data,function (data) {
                ...
                $(data).each(function (k,v) {
                    var editurl = "{{url('admin/QT/')}}/"+v.id+'/edit'
